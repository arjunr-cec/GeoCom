...
<?php
                    ...
                    if(isset($_POST['sub1']))
 {
    ...
    $ins=mysqli_query($dbcon,"insert into shop_reg values('','$t1','$t2','$t3','$t4','$t5','$t6','$t7','$t8','$nfn','0')");
    
    if($ins>0)
    {
      $ins1=mysqli_query($dbcon,"insert into user_log values('','$t3','$t4','shop','0')");
        if($ins1>0)
        {
                header("location:shopreg.php?suss=1");
            }
    }
        }
 }
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
              <p class="breadcrumbs"><span class="mr-2"><a href="index.php">Home</a></span> <span>New SHOP</span></p>
            <h1 class="mb-0 bread">NEW SHOP REGISTRATION</h1>
          </div>
        </div>
      </div>
    </div>
    <div class="container">
        <center><h3 style="padding: 10px;">SHOP REGISTRATION</h3></center>
        <div class="row">
        <div class="col-md-6">
            <form method="post"enctype="multipart/form-data">
                <div class="form-group">
                    <input type="text" required="" class="form-control" name="t1" placeholder="Shop Name">
                </div>
                <div class="form-group">
                    <select class="form-control" name="t2">
                        ...
                        <?php
                                        $sel_state=mysqli_query($dbcon,"select * from s_cate");
                ...
                <div class="form-group">
                    <input type="email" class="form-control" name="t3" placeholder="Email ID"onkeyup="vem(this.value)" /><span id="em"></span>
                </div>
                <div class="form-group">
                    <input type="password"required="" class="form-control" name="t4" placeholder="Password">
                </div>
                <div class="form-group">
                    <textarea class="form-control"required="" name="t5" placeholder="Address"></textarea>
                </div>
                <div class="form-group">
                    <input type="text" required=""required="" class="form-control" name="t6" placeholder="Contact Number"onkeyup="chkc(this.value)" /><span id="o3"></span>
                </div>
                <div class="form-group">
                    <input type="file" required=""class="form-control" name="myFile" placeholder="photo">
                </div>
                
                <div class="form-group">
                    <input type="text" required=""required="" name="t7"id="lat" class="form-control"value="">
                </div>
                <div class="form-group">
                    <input type="text" required=""required="" name="t8" id="lng"class="form-control"value="">
                </div>
                <div class="form-group"><center>
                    <input type="submit"required="" name="sub1" value="REGISTER NOW" class="btn btn-success" />
                    </center>
                </div>
            </form>
        </div>
      ...
      function initAutocomplete() {
        var map = new google.maps.Map(document.getElementById('map'), {
          center: {lat: 9.152967, lng: 76.735611},
          zoom: 18,
          mapTypeId: 'roadmap'
        });
