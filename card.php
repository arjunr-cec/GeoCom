...
<?php
                    ...
                    if(isset($_POST['sub1']))
 {
    ...
    $ins=mysqli_query($dbcon,"insert into user_data1 values('','$t1','$t2','$t3','$t4','$t5','$t6','$t7','$nfn','$ta')");
    
    if($ins>0)
    {
      
                header("location:card.php?suss=1");
            }
    }
        }
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            ...
            <h1 class="mb-0 bread">CARD HOLDER REGISTRATION</h1>
          </div>
        </div>
      </div>
    </div>
    <div class="container">
        <center><h3 style="padding: 10px;">CARD HOLDER REGISTRATION</h3></center>
        <div class="row">
        <div class="col-md-6">
            <form method="post"enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <input type="text" class="form-control" name="t3" placeholder="Card Limit">
                </div>
                <div class="form-group">
                    <textarea class="form-control" name="t4" placeholder="Card Details"></textarea>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <input type="text" required="" class="form-control" name="ta" placeholder="Bank">
                </div>
                <div class="form-group">
